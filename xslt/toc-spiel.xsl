...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <xsl:variable name="doc_title" select="'Spiel Papers'"/>
        <html lang="en">
            <head>
                            ...
                            <div class="tab-pane active" id="cards-tab" tabindex="-1">
                                <div class="row gy-1 text-center">
                                    <xsl:call-template name="toc-cards">
                                        ...
                                        <xsl:with-param name="category" select="'spiel'"/>
                                        <xsl:with-param name="project-dir" select="'data/aad/editions'"/>
                                        <xsl:with-param name="max_date" select="xs:date('2100-12-31')"></xsl:with-param>
                                        <xsl:with-param name="low_date" select="xs:date('1900-01-01')"></xsl:with-param>
                                    </xsl:call-template>
                                </div>
                            </div>
